...
public class MainView {
    ...
    public MainView(SimulationController controller) {
        ...
        terrainCanvas = new TerrainCanvas(controller);
        ...
        resetBtn.setOnAction(e -> controller.execute(new com.example.lab4.simulation.controller.commands.ResetSimulationCommand()));

        controls.getChildren().addAll(startBtn, stopBtn, pauseBtn, resumeBtn, resetBtn);

        // Ползунок для управления тягой
        VBox throttleBox = new VBox(5);
        throttleBox.setPadding(new Insets(10));
        Label label = new Label("Throttle Force");
        Slider throttleSlider = new Slider(-5000, 5000, 0); // диапазон сил тяги
        ...
        VBox leftPanel = new VBox(20, controls, throttleBox);
